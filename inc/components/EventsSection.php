...
<body>
    ...
    <!-- Events Container contains 6 latest events-->
        ...
        <div class="parent">
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<a href="./pages/event_page.php?id=' . $fundId . '">';

                    /* str_replace(' ', '%20', $fundCover) function replaces any spaces in the $fundCover variable with "%20", 
                    which is the URL-encoded representation of a space. 
                    This is necessary because URLs cannot contain spaces directly. */
